...
export class Assets{
    ...
    static CanvasCSS = require('./css/canvas.css.asset');
    static CanvasDesignerCSS = require('./css/designer-canvas.css.asset');
    ...
    static BootstrapJS = require('./bootstrap/js/bootstrap.bundle.min.js.asset'); //Used for preview
    static JqueryJS = require('./bootstrap/js/jquery.min.js.asset'); //Bootstrap.js depends on jQuery
